...
ActiveRecord::Schema.define(:version => 20110110205815) do
  ...
  create_table "accents", :force => true do |t|
    ...
    t.string   "image_hover_file_name"
    t.string   "image_hover_content_type"
    t.integer  "image_hover_file_size"
    t.datetime "image_hover_updated_at"
    t.string   "image_title_file_name"
    t.string   "image_title_content_type"
    t.integer  "image_title_file_size"
    t.datetime "image_title_updated_at"
  end
